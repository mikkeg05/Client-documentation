...
namespace ClientDocumentation.Web.Composers
{
    ...
    public class AttachMediaComposer : ComponentComposer<AttachMediaComponent>
    {
        
    }
    public class AttachMediaComponent : IComponent
    {
        private readonly IMediaComposerService _mediaComposerService;
        private readonly IMediaService _mediaService;

        public AttachMediaComponent (IMediaComposerService mediaComposerService, IMediaService mediaService) 
        {
        ...
        private void ContentService_Published(IContentService sender, Umbraco.Core.Events.ContentPublishedEventArgs e)
        {
            ...
            foreach(var publishedItem in e.PublishedEntities) 
            {
                ...
                if(publishedItem.ContentTypeId == 1068)
                    _mediaComposerService.ContentServicePublished(clientFolder, publishedItem, publishedItem.ContentTypeId, helper);
            }
