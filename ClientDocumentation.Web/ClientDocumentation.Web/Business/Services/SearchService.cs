...
namespace ClientDocumentation.Web.Business.Services
{
    public class SearchService : ISearchService
    {
        ...
        public List<string> QueryStrings(HttpRequestBase Request) 
        {
        ...
        public string GetRequestQuery(HttpRequestBase Request) 
        {
        ...
        public SearchPageViewModel GetSearchPageViewModel(Search search, List<string> strings, string query, UmbracoContext context)
        {
            ...
            if (!string.IsNullOrEmpty(stringBuilder.ToString()))
            {
                ...
                {
                    searchPageViewModel.NoResultMessage = "Couldn't find anything based on this search";
                }
